...
// 八方向卷積核
const int dx[8][3][3] = {
    {{ 0, 0, 0}, {-1, 0, 1}, { 0, 0, 0}},  // 水平 (左右差)
    {{ 0,-1, 0}, { 0, 0, 0}, { 0, 1, 0}},  // 垂直 (上下差)
    {{-1, 0, 1}, { 0, 0, 0}, { 1, 0,-1}},  // 斜對角1 (左上->右下)
    {{ 0, 1, 0}, {-1, 0, 1}, { 0,-1, 0}},  // 斜對角2 (右上->左下)
    {{ 1, 0, 0}, { 0, 0, 0}, { 0, 0,-1}},  // 斜對角3 (左->右斜下)
    {{ 0, 1, 0}, { 0, 0, 0}, { 0,-1, 0}},  // 斜對角4 (上->下)
    {{ 0, 0, 0}, { 1, 0,-1}, { 0, 0, 0}},  // 水平反向
    {{ 0, 1, 0}, { 0, 0, 0}, { 0,-1, 0}}   // 垂直反向
};
